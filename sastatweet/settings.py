"""
Django settings for sastatweet project.
...
SECRET_KEY = 'django-insecure-_qmu^r9md(vs)9a!mfbgo+0oxf#nsmecgak=7i#sxh#)*m4v(b'
...
# Static files settings (these will remain in your GitHub repository)
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles_build', 'static')
